...
abstract class Exporter
{
    ...
    {
        return [ExportFormat::Csv,ExportFormat::Pdf, ExportFormat::Xlsx];
    }
    ...
    public function getPdfHeaderStyle(Iterator $record): string
    {
        return '';
    }

    public function getPdfFooterStyle(Iterator $record): string
    {
        return '';
    }

    public function getPDFPreviousContent(): array
    {
        return [];
    }

    public function getPDFTablePreviousContent(Iterator $record): array
    {
        return [];
    }
    public function getPDFTableAfterContent(Iterator $record): array
    {
        return [];
    }
    public function getPDFAfterContent(Iterator $record): array
    {
        return [];
    }
}
